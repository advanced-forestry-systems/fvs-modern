...
G.VARIANT_STATES.setdefault("cr",(8,56,49,35))
_ABBR={8:"CO",56:"WY",49:"UT",35:"NM"}; _o=G._state_abbrev
...
VAR="cr"; STATES=["CO","WY","UT","NM"]; MAXSP=38; M2HA=0.2296;TPHc=2.471;CMc=2.54
SCALES=[0.6,0.7,0.8,0.9,1.0,1.2]
frames=[]
for ab in STATES:
