...
// ===================================================================
{
  ...
  // Year-100 multi-model outcomes (AGM default, AGM MORTCAL, FVS-NE default, FVS-NE calibrated)
  ...
  const rows = [
    [{ text: "Stratum",          options: HDRY },
     ...
     { text: "FVS-NE cal Cords", options: HDRY }],
    [{ text: "Cedar / A+B (CFI)", options: { fill: { color: "FFF8E1" }, italic: true } },
                                   "1", "n/a", "81",  "n/a",  "n/a",  "35.8", "n/a"],
    ["Cedar / C+D",                "1", "206", "99",  "291",  "218",  "36.9", "66.4"],
    ["Hardwood / A+B",             "1", "209", "107", "209",  "144",  "39.3", "51.1"],
    ["Hardwood / C+D",             "3", "198", "108", "214",  "125",  "38.9", "44.0"],
    [{ text: "Mixedwood / A+B (CFI)", options: { fill: { color: "FFF8E1" }, italic: true } },
                                   "3", "n/a", "52",  "n/a",  "n/a",  "21.9", "n/a"],
    ["Mixedwood / C+D",            "1", "212", "102", "239",  "153",  "37.6", "51.3"],
    ["Commercial SW / A+B",        "2", "203", "98",  "274",  "225",  "35.9", "69.7"],
    ["Commercial SW / C+D",        "3", "211", "99",  "264",  "186",  "36.2", "58.9"],
    [{ text: "Other Softwood (no CFI)", options: { fill: { color: "F4F4F4" }, italic: true, color: "888888" } },
                                   "0", "—",   "—",   "—",    "—",    "—",   "—"]
  ];
  s.addTable(rows, {
    x: 0.2, y: 1.65, w: 12.95, h: 4.5,
    colW: [2.6, 0.55, 1.20, 1.55, 1.30, 1.30, 1.65, 1.75],
  ...
  citationLine(s, "Year-100 (2123) BA in ft^2/ac, Cords/ac. AGM = AcadianGY 12.3.9; FVS-NE Cardinal job 11078908 on 11 byStrata stands from GrownDB 2023 snapshot");
  takeawayBand(s, "AGM MORTCAL is the lowest projection; FVS-NE calibrated sits between AGM default and MORTCAL");
}
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_v9_Weiskittel.pptx`;
