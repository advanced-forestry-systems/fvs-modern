...
data {
  ...
  vector[N_obs] cspi_v6_z;   // CSPI v6 unified site index, standardized
...
parameters {
  ...
  real a_cspiv6;                     // CSPI v6 site index
...
model {
  ...
  vector[N_obs] eta =
    ...
    + a10 * bgi_x_bal
    + a_bard * ba_x_rd + a_blrd * bal_x_rd + a_cspiv6 * cspi_v6_z;
