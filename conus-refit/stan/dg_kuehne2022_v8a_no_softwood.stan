// ============================================================================
// dg_kuehne2022_v8a_no_softwood.stan
// (Derived from v8; the bgi * softwood interaction (b14) was
//  posterior-zero with broad CI in the v8 100K production fit
//  -- dropped for parsimony; trait/gamma still captures
//  softwood vs hardwood via gamma[3].)
//
