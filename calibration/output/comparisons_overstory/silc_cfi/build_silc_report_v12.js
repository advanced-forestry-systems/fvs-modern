...
children.push(new Paragraph({
  ...
  children: [new TextRun({ text: "Companion Report v12 — visual cleanup, supersubscripts", italics: true, size: 26 })],
}));
children.push(new Paragraph({
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_Report_v12_Weiskittel.docx`;
