// ============================================================================
// dg_kuehne2022_speciesfree_v8_forest_eco.stan
// v8: adds a FIA forest-type-group random intercept (z_FT) on top of the v6
//     ecoregion levels (z_L1/z_L2/z_L3), so the species-free equation now
//     depends on BOTH forest type and ecoregion. Non-centered, mirrors the
//     ecoregion levels. New data: N_FT, FT_idx. New params: z_FT_raw, sigma_FT.
// (derived from dg_kuehne2022_speciesfree_v6_data_driven.stan)
//
...
data {
  ...
  array[N_obs] int<lower=1, upper=N_FT> FT_idx;   // FIA forest-type group index
