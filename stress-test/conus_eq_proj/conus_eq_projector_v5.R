#!/usr/bin/env Rscript
## conus_eq_projector_v5.R (copy of v4) -- annualized stand projection using fvs-conus fitted equations,
...
ST_RATE<-as.numeric(ga("st_rate","0.20")); ST_EXP<-as.numeric(ga("st_exp","2.2"))  # v5 default = sweep set C
