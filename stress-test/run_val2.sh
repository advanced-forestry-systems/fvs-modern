...
python3 run_gompit_projection.py --variant ne --n 6 \
  ...
  --output out_gompit/ne_val_cc.csv --num-cycles 20 --cycle-length 5 --regen off \
  --arms default,calibrated,posthoc,iterative > out_gompit/ne_val_cc.log 2>&1
echo "EXIT=$?" >> out_gompit/ne_val_cc.log
