...
plots, with per-plot R^2 lifting from 0.38 to 0.48.
  ...
  v33 pooled refit + asymmetric cap                   +0.2 percent CV bias, R^2 0.484 on n=184
...
### v33: Pooled refit + asymmetric cap (production, PR #46)

Pool v30 + v32 (n=184). Refit shallower slope and apply asymmetric cap so
the correction can only subtract from BA_pred. 5-fold CV (50 shuffles):

  Uncorrected            +14.46 percent  R^2 0.380
  Symmetric +/-25 cap    +1.38 +/- 0.12  R^2 0.472
  **Asymmetric (0, +25)** **+0.21 +/- 0.11**  **R^2 0.484**
...
Crossover at BA_t1 = 156.6 ft^2/ac. Beyond that, the raw BA_pred is
preserved.
...
#46 v33 pooled refit + asymmetric cap (current ship)
