// build_silc_deck_v5.js
// =====================================================================
// SILC operational deck v5 for Ian / Ryan at Seven Islands.
// Extends v4 with: scorecard verification corrections, FVS-ACD
// default/calibrated combined row + footnote (calibration not binding
// below stand BA 150), species comp renormalized to identified groups,
// cross-region context (FIA 12029 plot validation reference).
// =====================================================================
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_v5_Weiskittel.pptx`;
