...
// ===================================================================
{
  ...
  s.addText("Earliest to latest CFI measurement per plot. Mean 10 yr horizon. n=6 routine pairs", {
    x: 0.5, y: 1.05, w: 12.3, h: 0.45,
    fontFace: "Aptos", fontSize: 16, color: MED_GRAY, italic: true,
    align: "left", valign: "top"
  });
  ...
  const tab = [
    ...
    ["AcadianGY default",    "+6.1%",  "+18.5%", "+7.0%",  "+19.3%", "+8.4%",  "+16.7%"],
  ...
  takeawayBand(s, "AcadianGY MORTCAL cuts long horizon bias by more than half, beats all defaults on BdFt");
}
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_v12_Weiskittel.pptx`;
