...
children.push(new Paragraph({
  ...
  children: [new TextRun({ text: "Companion Report v13 — v16 CFI expansion (n=65)", italics: true, size: 26 })],
}));
children.push(new Paragraph({
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_Report_v13_Weiskittel.docx`;
