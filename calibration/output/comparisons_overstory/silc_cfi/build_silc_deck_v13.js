...
// ===================================================================
{
  ...
  s.addTable(tab, {
    ...
    colW: [3.0, 0.55, 1.45, 1.50, 1.50, 1.75, 1.75],
    fontFace: "Aptos", fontSize: 12, color: CHARCOAL,
    border: { type: "solid", pt: 0.5, color: "DDDDDD" },
    align: "center", valign: "middle",
    rowH: 0.22
  ...
  s.addText("n=65 routine pairs (8 establishment events excluded). Cardinal jobs 11105908 (AcadianGY), 11106519 (FVS), 11106515 (OSM).", {
    x: 0.5, y: 6.30, w: 12.5, h: 0.30,
    fontFace: "Aptos", fontSize: 10, color: LIGHT_GRAY, italic: true,
    align: "left", valign: "middle"
  });
  takeawayBand(s, "AcadianGY MORTCAL lowest BA bias (−1.3%); OSM-ACD second; all 4 models within ±7% on n=65");
}
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_v13_Weiskittel.pptx`;
