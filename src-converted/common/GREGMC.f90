...
REAL    GDG(MAXSP,7), GHG(MAXSP,9), GEMT, GTD, GELEV
LOGICAL LGREGDG, LGREGHG, GHAVE_DG(MAXSP), GHAVE_HG(MAXSP)
COMMON /GREGMR/ GDG, GHG, GEMT, GTD, GELEV
COMMON /GREGMI/ NGREGDG, NGREGHG
COMMON /GREGML/ LGREGDG, LGREGHG, GHAVE_DG, GHAVE_HG
