...
// ===================================================================
{
  ...
  // Three rec cards
  const recs = [
    { title: "FVS-NE calibrated for 5 to 15 year operational projections",
      body: "Lowest bias across short and long horizons (BA -0.3% at 5 yr, +6% at 10 yr; cords -3.8% / +4.6%). Validated Cardinal pipeline, default + calibrated.",
      accent: CRSF_GREEN },
    { title: "AGM for sawlog BdFt and long horizon strata yield",
      body: "Sawlog champion at all horizons (R^2 0.81 to 0.94). 100 year strata cords trajectories drive allowable cut. AGM BA bias grows to +18% at 10 yr - prefer FVS-NE for BA.",
      accent: CRSF_GREEN },
    { title: "Bracket with OSM-ACD as the conservative under projection",
      body: "OSM-ACD is the lower bound at all horizons (-8 to -10% bias). Report FVS-NE plus OSM as a range; per plot RMSE 14 ft^2/ac BA at 10 yr horizon.",
      accent: CRSF_GREEN }
  ];
...
// ===================================================================
{
  ...
  s.addText("n=6 routine pairs after excluding 2 plots with 3x BA ingrowth establishment events (1105, 1107)", {
    x: 0.5, y: 6.30, w: 12.5, h: 0.30,
    fontFace: "Aptos", fontSize: 10, color: LIGHT_GRAY, italic: true,
    align: "left", valign: "middle"
  });
  takeawayBand(s, "AGM bias accumulates 2-3x at long horizon, FVS-NE calibrated stays best");
}
...
const out = `${CFI_DIR}/SILC_4Model_Benchmark_v6_Weiskittel.pptx`;
