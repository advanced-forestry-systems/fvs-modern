...
VAR=os.environ.get("VAR","pn"); STATES=os.environ.get("STATES","OR,WA").split(","); MAXSP=int(os.environ.get("MAXSP","39"))
import fia_stand_generator as _G0
_G0.VARIANT_STATES.setdefault("cr",(8,56,49,35))
_G0.VARIANT_STATES.setdefault("pn",(41,53))
_ABBR={8:"CO",56:"WY",49:"UT",35:"NM",4:"AZ",30:"MT",16:"ID",41:"OR",53:"WA"}
_orig_ab=_G0._state_abbrev
def _ab2(c):
    return _ABBR.get(c) or _orig_ab(c)
_G0._state_abbrev=_ab2
...
out=P.replace("fvs-modern","fvs-conus")+"/output/%s_sdimax_demo"%VAR
